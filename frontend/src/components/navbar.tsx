      ...
      <div className="container mx-auto px-4 h-full max-w-full sm:max-w-[80vw] md:max-w-[70vw] lg:max-w-[60vw]">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden sm:flex items-center gap-8">
            ...
            <NavItem icon={<MessageSquareText />} label="Messaging" to="/messaging" />
            {/* <NavItem icon={<BellIcon />} label="Notifications" to="/notifications" /> */}
            <button onClick={subscribeUser}><BellIcon/></button>
