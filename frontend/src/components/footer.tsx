...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white py-4 text-sm text-gray-700 mt-8">
      <div className="max-w-full mx-auto flex flex-wrap items-center justify-center">
        <div className="flex items-center mr-0 md:mr-7">
          <img src={logo} alt="Logo" className="h-8 w-24 mr-1 cursor-default" />
          <span className="cursor-default">
            &copy; {new Date().getFullYear()}
          </span>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mt-4 md:mt-0">
